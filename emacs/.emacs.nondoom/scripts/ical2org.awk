...
BEGIN {
    ...
    author = ENVIRON["AUTHOR"] != "" ? ENVIRON["AUTHOR"] : "Christoffer Arvidsson"

    # and to your email address
    emailaddress = ENVIRON["EMAIL"] != "" ? ENVIRON["EMAIL"] : "christoffer.arvidsson@zenseact.com"

    # main title of the Org file
    title = ENVIRON["TITLE"] != "" ? ENVIRON["TITLE"] : "Main work outlook calendar entries"

    # calendar/category name for display in org-mode
    calendarname = ENVIRON["CALENDAR"] != "" ? ENVIRON["CALENDAR"] : "work"

    # any tags for this calendar (e.g. "WORK" or "PERSONAL")
    filetags = ENVIRON["FILETAGS"] != "" ? ENVIRON["FILETAGS"] : "work:meeting"
