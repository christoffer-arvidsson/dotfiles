...
base02 = "#635850"  # medium background (active border)
base03 = "#7f7f7f"  # gray text, borders
base04 = "#b0a0cf"  # light background (tab)
base05 = "#efd5c5"  # foreground text
base06 = "#d09950"  # light accent (yellowish)
base07 = "#ffffff"  # white
base08 = "#ff6f6f"  # red (error messages, etc.)
base09 = "#ff7a5f"  # orange (hover, active links)
base0A = "#c0b24f"  # yellow
base0B = "#7fce5f"  # green
base0C = "#3fc489"  # cyan
base0D = "#80aadf"  # blue
base0E = "#ffaacf"  # magenta
base0F = "#deb07a"  # brown
...
c.colors.statusbar.normal.fg = base0D
